...
export function PinContainer({
  ...
  var [transform, setTransform] = useState("translate(-50%,-50%) rotateX(0deg) scale(1)");
  ...
  return (
    ...
    >
      <div className="absolute left-1/2 top-1/2 ml-[0.09375rem] mt-4 -translate-x-1/2 -translate-y-1/2" style={{ perspective: "1000px", transformStyle: "preserve-3d" }}>
        <div
